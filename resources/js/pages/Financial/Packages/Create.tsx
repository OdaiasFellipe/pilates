...
import PackagesController, { index } from '@/actions/App/Http/Controllers/PackagesController';
...
export default function PackagesCreate() {
    ...
    const submit = (e: React.FormEvent) => {
        e.preventDefault();
        post(PackagesController.store.url());
    };

    return (
        <>
            <Head title="Novo Pacote" />

            <div className="mx-auto max-w-3xl p-6">
                <h1 className="mb-6 text-2xl font-semibold">Novo Pacote</h1>
