...
import type { ProfessionalFormData, WorkingHourSlot } from '@/types';

const DAYS = ['Dom', 'Seg', 'Ter', 'Qua', 'Qui', 'Sex', 'Sáb'] as const;

export default function CreateProfessional() {
    const { data, setData, post, processing, errors } = useForm<ProfessionalFormData>({
        name: '',
        email: '',
        password: '',
    ...
    const submit = (e: React.FormEvent) => {
        e.preventDefault();
        post(ProfessionalsController.store.url());
    };
        ...
        <>
            ...
            <div className="mx-auto max-w-3xl p-6">
                <div className="mb-6">
                    ...
                    <p className="text-sm text-muted-foreground">Preencha os dados do profissional</p>
                </div>
